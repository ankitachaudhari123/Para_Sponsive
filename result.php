...
$ankita = " SELECT * FROM products WHERE p_name LIKE '%$search%' OR p_price LIKE '%$search%' OR p_des LIKE '%$search%'";
//$ankita = "SELECT count(p_id) as total_amount FROM products;";
...
<script type="text/javascript">
  ...
  //   var div_id = $('.cat-item').attr("id");
  //   alert(div_id);
  //     $('.cat-item').addClass("background-change");
  // }

  // function normalImage(){
  //   $('.first').removeClass("background-change");
  // }
