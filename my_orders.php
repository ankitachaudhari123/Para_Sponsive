...
<div class="card">
    <div class="row">
      ...
      <div class="col-md-7"style=" height: 200px;">
        <h1 style="margin-top: 10%;color: black;font-size: 20px;">ORDER ID : <?=$row['order_id']?></h1>
        <h1 style="color: black;font-size: 20px;">ORDER DATE : <?=$row['order_date']?></h1>
        <br>
       
        <a href="view-order-products.php?order_id=<?=$row['order_id']?>">View</a> | 
        <?php 
        if ($row['status'] == 0) {
          ?>

          <a href="" class="request_cancel" id="<?=$row['id']?>">Request Cancel</a>
          <?php
        }
        else if ($row['status'] == 1) {
          echo '<span class="badge badge-primary">Confirm</span>';
        }
      ...
      <div class="col-md-4"style=" height: 200px;">
        <h1 style="color: black;font-size: 20px;margin-top: 20%;">Total Amount: <?=$row['total_amount']?></h1>
        <h1 style="color: black;font-size: 20px;margin-top: 5%;">Shipping amount: <?=$row['shipping_amount']?></h1>
        <h1 style="color: black;font-size: 20px;margin-top: 5%;">Grand amount: <?=$row['grand_total']?></h1>
      </div>
    </div>
    </div>
...
$('.delete_prorduct').click(function(e){
  e.preventDefault();
...
url:'php/update_order_states.php',
method:'GET',
